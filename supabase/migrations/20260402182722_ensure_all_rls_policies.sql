...
DROP POLICY IF EXISTS "Allow authenticated users to insert a new comment." ON comments;
DROP POLICY IF EXISTS "Allow users to view all comments." ON comments;
DROP POLICY IF EXISTS "Allow users to delete their own comment." ON comments;

DROP POLICY IF EXISTS "Allow authenticated users to insert a new comment like." ON comment_likes;
DROP POLICY IF EXISTS "Allow users to view all comment likes." ON comment_likes;
DROP POLICY IF EXISTS "Allow users to delete their own comment like." ON comment_likes;
