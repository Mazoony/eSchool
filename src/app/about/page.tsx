...
export const metadata: Metadata = {
  title: 'About eSchool',
  description: 'Learn about the mission and vision of eSchool, the leading online platform for English language education in Sudan.',
  alternates: {
    canonical: 'https://eschool.com/about',
  },
};
  ...
  return (
    <div className="container mx-auto px-6 py-12">
      <div className="prose dark:prose-invert max-w-4xl mx-auto">
        ...
        <h2>What We Offer</h2>
        <ul>
          <li><strong>Comprehensive Courses:</strong> From beginner lessons to advanced IELTS preparation, our curriculum is designed to meet the diverse needs of our learners.</li>
          <li><strong>Expert Instructors:</strong> Our team of certified educators is passionate about teaching and dedicated to providing personalized feedback and support.</li>
          <li><strong>Interactive Platform:</strong> Our social learning platform encourages practice, collaboration, and connection, making the learning process engaging and effective.</li>
          <li><strong>Flexible & Accessible:</strong> Learn at your own pace, on your own schedule, from anywhere in Sudan.</li>
        </ul>
