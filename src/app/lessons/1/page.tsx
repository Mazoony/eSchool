  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="flex-1 p-4 md:p-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-4">Introduction to English Grammar</h1>
        <div className="rounded-lg border bg-card text-card-foreground shadow-sm bg-white dark:bg-gray-800 p-6">
          <p className="text-gray-500 dark:text-gray-400">This lesson will cover the basics of English grammar, including parts of speech, tenses, and sentence structure. The full lesson content is coming soon!</p>
        </div>
      </main>
    </div>
  );
